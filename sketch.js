...
function setup() {
  ...
  block33 = new Polygon(150,100,30,40);

  slingShot = new SlingShot(block33.body,{x:150,y:50});
}
function draw() {
  background(56,44,44); 
...
function mouseDragged(){
  Matter.Body.setPosition(block33.body, {x: mouseX , y: mouseY});
}
